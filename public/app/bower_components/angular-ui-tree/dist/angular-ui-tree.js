...
(function () {
  ...
  angular.module('ui.tree')
    ...
    .controller('TreeNodesController', ['$scope', '$rootScope', '$element', '$timeout', 'treeConfig',
      function ($scope, $rootScope, $element, $timeout, treeConfig) {
        this.scope = $scope;
...
(function () {
  ...
  angular.module('ui.tree')
    ...
    .controller('TreeNodeController', ['$scope', '$element', '$attrs', '$rootScope', 'treeConfig',
      function ($scope, $element, $attrs, $rootScope, treeConfig) {
        this.scope = $scope;
        ...
        $scope.toggle = function(element, node) {
            if(node) {
                console.log(node);
            } else {
...
(function () {
  ...
  angular.module('ui.tree')
    ...
    .directive('uiTreeNode', ['treeConfig', '$uiTreeHelper', '$window', '$document','$timeout', '$rootScope', '$http',
      function (treeConfig, $uiTreeHelper, $window, $document, $timeout, $rootScope, $http) {
        return {
